...
Try {
	...
	[string]$appName = 'AutoCAD Civil 3D'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        # Check if other AutoCAD application is installed, then only uninstall AutoCAD Civil components:
        If ((Get-InstalledApplication -ProductCode '{28B89EEF-1007-0000-0102-CF3F3A09B77D}') -Or (Get-InstalledApplication -ProductCode '{28B89EEF-1005-0000-0102-CF3F3A09B77D}')){
